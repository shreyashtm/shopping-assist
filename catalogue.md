...
- 56 populated subcategories, across 66 taxonomy paths total (11 still empty)
...
scripts/enrich.py          Claude Batch API -> use_case, occasion, season,
                            temp_rating_c, material
